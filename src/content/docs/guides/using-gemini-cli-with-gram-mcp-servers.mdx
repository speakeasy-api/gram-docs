---
title: "Using Gemini CLI with Gram MCP servers"
...
If you already have a Gram MCP server configured, you can skip to [connecting Gemini CLI to your server](#connect-gemini-cli-to-your-mcp-server). Otherwise, let's set up the Push Advisor example now.

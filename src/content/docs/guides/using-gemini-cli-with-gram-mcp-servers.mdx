...
![Gemini CLI intro](/img/guides/mcp-gemini/gemini-cli-intro.png)
...
You should see Gemini CLI's available commands and options.
...
If you already have a Gram MCP server configured, you can skip to [connecting Gemini CLI to your server](#connect-gemini-cli-to-your-mcp-server). Otherwise, let's quickly set up the Push Advisor example.
...
![New project in Gram](/img/guides/mcp-gemini/gram-new-project.png)
...
![Upload OpenAPI Spec](/img/guides/mcp-gemini/upload-openapi-spec.png)
...
![Fill environment variables](/img/guides/mcp-gemini/fill-env-vars-toolset.png)
...
![Set server URL](/img/guides/mcp-gemini/set-server-url.png)
...
![MCP Details](/img/guides/mcp-gemini/mcp-details.png)

Scroll down to the **MCP Config** section and copy the Public Server configuration.

![Push Advisor MCP Server](/img/guides/mcp-gemini/copy-mcp-config.png)
...
Copy your MCP server configuration from Gram for either the Public Server or the Authenticated Server and add the configuration to your `.gemini/settings.json` file.

![Gemini CLI settings.json](/img/guides/mcp-gemini/gemini-cli-settings-json.png)
...
![Gemini CLI MCP Status](/img/guides/mcp-gemini/gemini-cli-mcp-status.png)

You can also view more details about the servers' tools by using `ctrl + t` to view the tool details.

![Gemini CLI Toggle Tool Details](/img/guides/mcp-gemini/gemini-cli-toggle-tool-details.png)
...
![Gemini CLI Tool Permission](/img/guides/mcp-gemini/gemini-cli-tool-permission.png)
...
![Gemini CLI Push Request](/img/guides/mcp-gemini/gemini-cli-push-request.png)
...
![Gemini CLI Debug Issue](/img/guides/mcp-gemini/gemini-cli-debug-issue.png)

---
title: "Using your IDE with Gram MCP servers"
description: "Learn how to create Gram-hosted MCP servers and connect them to your IDE, giving your AI assistants access to your APIs and tools."
sidebar:
  order: 4
---
...
This guide will show you how to create a Gram-hosted MCP server and use it across some of the most popular IDE-based AI assistants.
...
If you already have a Gram MCP server configured, you can skip to the [Installing MCP servers in your IDE](#installing-mcp-servers-in-your-ide) section. Otherwise, let's set up the Push Advisor example now.
...
The configuration you copied from Gram will work across all MCP-compatible clients. We'll show you how to add it to the most popular IDE-based AI assistants.

...
We'll also use [x-gram extensions](/concepts/openapi#using-the-x-gram-extension) to add context that helps the assistant (LLM-based agent) understand your TaskBoard tools more accurately:
...
3. Upload your OpenAPI document (the generated `public/swagger.json` from Step 1)

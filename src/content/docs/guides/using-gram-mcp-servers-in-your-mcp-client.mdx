---
title: "Using MCP clients with Gram-hosted MCP servers"
description: "Learn how to create Gram-hosted MCP servers and connect them to MCP clients to give your AI assistants access to your APIs and tools."
sidebar:
  order: 4
---
...
This guide shows you how to create a Gram-hosted MCP server and use it across some of the most popular MCP clients.
...
- An MCP client. This guide covers Claude Desktop, Cursor, VS Code with Copilot, Windsurf, and Amp.
...
These configurations will work across all MCP clients. Next, we'll show you how to add MCP server configurations to the most popular MCP clients.

## Adding the Gram-hosted MCP server to Claude Desktop
...
If your MCP host can't connect to the Gram server:
...
- Try restarting your MCP host after making configuration changes.
...
If the tools aren't showing up in your MCP host:
...
- Look for any error messages in your MCP host's logs.

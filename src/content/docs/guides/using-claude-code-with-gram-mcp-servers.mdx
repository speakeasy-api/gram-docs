...
![Claude Code intro](/img/guides/claude-code-intro.png)
...
Before starting, install **Claude Code CLI** ([install from Anthropic](https://docs.anthropic.com/en/docs/claude-code)) and create **a Gram account** (sign up at [getgram.ai](https://getgram.ai)).
...
![Upload OpenAPI Spec](./assets/upload-openapi-spec.png)
...
![Push Advisor create toolset](./assets/create-toolset.png)


#### Step 3 - Configure MCP

![Configure MCP](./assets/configure-mcp.png)
...
![Claude Code MCP Install](/img/guides/claude-code-mcp-install.png)
...
<div class="flex justify-center">
  <video controls>
    <source src="/videos/claude-code-showcase.mp4" type="video/mp4"></source>
...
![Claude Code Tool Permission](/img/guides/claude-code-tool-permission.png)
...
![Claude Code Push Request](/img/guides/claude-code-push-request.png)

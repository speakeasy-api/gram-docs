---
title: "Using Claude Code with Gram MCP servers"
...
If you already have a Gram MCP server configured, you can skip to [Step 2](#connect-claude-code-to-your-gram-server). Otherwise, let's set up the Push Advisor example now.
...
## Connecting Claude Code to your Gram server

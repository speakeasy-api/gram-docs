...
```bash
pip install langgraph langchain-mcp-adapters langchain-openai python-dotenv
# or for Anthropic
# pip install langgraph langchain-mcp-adapters langchain-anthropic python-dotenv
```

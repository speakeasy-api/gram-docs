...
- `--scope project` adds the server to a local .mcp.json file that can be checked into your source control and shared with other users on the project. You can [read more about other scope options](https://docs.anthropic.com/en/docs/claude-code/mcp#mcp-installation-scopes) at Anthropics documentation.

...
3. **Publish** – Test the setup in the playground, then deploy it as an MCP server or connect using the SDK.
...
- **Generate tools:** Use an OpenAPI document or a pre-built integration (like GitHub or Slack) to create callable tools.
